...
int main() {
    Window window(1440, 900, "threecpp v3.8 MeshStandardMaterial channel lab");
    ...
    std::cout << "v3.8 MeshStandardMaterial channel lab: metallicRoughness G/B, ao uv2, normalScale, transparent depthWrite.\n";
