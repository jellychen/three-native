...
#include "platform/AngleContext.hpp"
...
int main() {
    try {
        Window window(1280, 720, "threecpp v0.7 GLFW + ANGLE renderer test");
        AngleContext angle;
        angle.initialize(window);
        ...
        std::cout << "threecpp v0.7 GLFW + ANGLE renderer test running. Press ESC to exit.\n";
